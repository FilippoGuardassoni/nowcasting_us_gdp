...
csv_in='/Users/amministratore/Documents/Data Science/Thesis/Resources/Dataset/FRED Dataset/fred-md/monthly/2022-12.csv';
...
dataset=array2table(yt,"VariableNames",series);

DATE=dum.textdata(5:end,1);

DATE=datetime(DATE,'Format','MM/uuuu');

dataset=addvars(dataset,DATE,'Before',"RPI");

writetable(dataset,'/Users/amministratore/Documents/Data Science/Thesis/Resources/Dataset/dataset.csv');



%==========================================================================
csv_in_gdp='/Users/amministratore/Documents/Data Science/Thesis/Resources/Dataset/GDP.csv';

gdp_raw=readtable(csv_in_gdp);
